            ...
            try {
                ...
                if (!String.IsNullOrEmpty(deletedPropVal)) {
                    ...
                    if (origStartDate != copiedAi.Start) { /* Item moved, not copied */
                        if (origStartDate < Settings.Instance.ActiveCalendarProfile.SyncStart && copiedAi.Start >= Settings.Instance.ActiveCalendarProfile.SyncStart) {
                            Int16 newDaysInPast = (Int16)(Settings.Instance.ActiveCalendarProfile.SyncStart.Date - origStartDate.Date).TotalDays;
                            System.Windows.Forms.OgcsMessageBox.Show("An already synced appointment has been moved back into the synced date range.\r\n" +
                                "In order to avoid it being deleted, configuration has automatically been updated to " + (Settings.Instance.ActiveCalendarProfile.DaysInThePast + newDaysInPast) + " days in the past.\r\n" +
                                "After the next sync you may revert it to " + Settings.Instance.ActiveCalendarProfile.DaysInThePast + ".", "Appointment moved into synced date range",
                                System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation);
                            Forms.Main.Instance.SetControlPropertyThreadSafe(Forms.Main.Instance.tbDaysInThePast, "Text", (Settings.Instance.ActiveCalendarProfile.DaysInThePast + newDaysInPast).ToString());

                        } else if (origStartDate >= Settings.Instance.ActiveCalendarProfile.SyncStart && copiedAi.Start < Settings.Instance.ActiveCalendarProfile.SyncStart) {
                            Int16 newDaysInPast = (Int16)(Settings.Instance.ActiveCalendarProfile.SyncStart.Date - copiedAi.Start.Date).TotalDays;
                            System.Windows.Forms.OgcsMessageBox.Show("An already synced appointment has been moved out of the synced date range.\r\n" +
                                "In order this is synced, configuration has automatically been updated to " + (Settings.Instance.ActiveCalendarProfile.DaysInThePast + newDaysInPast) + " days in the past.\r\n" +
                                "After the next sync you may revert it to " + Settings.Instance.ActiveCalendarProfile.DaysInThePast + ".", "Appointment moved out of synced date range",
                                System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation);
                            Forms.Main.Instance.SetControlPropertyThreadSafe(Forms.Main.Instance.tbDaysInThePast, "Text", (Settings.Instance.ActiveCalendarProfile.DaysInThePast + newDaysInPast).ToString());

                        } else if (origStartDate > Settings.Instance.ActiveCalendarProfile.SyncEnd && copiedAi.Start <= Settings.Instance.ActiveCalendarProfile.SyncEnd) {
                            Int16 newDaysInFuture = (Int16)(origStartDate - Settings.Instance.ActiveCalendarProfile.SyncEnd.Date).TotalDays;
                            System.Windows.Forms.OgcsMessageBox.Show("An already synced appointment has been moved into the synced date range.\r\n" +
                                "In order this is synced, configuration has automatically been updated to " + (Settings.Instance.ActiveCalendarProfile.DaysInTheFuture + newDaysInFuture) + " days in the future.\r\n" +
                                "After the next sync you may revert it to " + Settings.Instance.ActiveCalendarProfile.DaysInTheFuture + ".", "Appointment moved into synced date range",
                                System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation);
                            Forms.Main.Instance.SetControlPropertyThreadSafe(Forms.Main.Instance.tbDaysInTheFuture, "Text", (Settings.Instance.ActiveCalendarProfile.DaysInTheFuture + newDaysInFuture).ToString());

                        } else if (origStartDate <= Settings.Instance.ActiveCalendarProfile.SyncEnd && copiedAi.Start > Settings.Instance.ActiveCalendarProfile.SyncEnd) {
                            Int16 newDaysInFuture = (Int16)(copiedAi.Start.Date - Settings.Instance.ActiveCalendarProfile.SyncEnd.Date).TotalDays;
                            System.Windows.Forms.OgcsMessageBox.Show("An already synced appointment has been moved out of the synced date range.\r\n" +
                                "In order this is synced, configuration has automatically been updated to " + (Settings.Instance.ActiveCalendarProfile.DaysInTheFuture + newDaysInFuture) + " days in the future.\r\n" +
                                "After the next sync you may revert it to " + Settings.Instance.ActiveCalendarProfile.DaysInTheFuture + ".", "Appointment moved out of synced date range",
                                System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Exclamation);
                            Forms.Main.Instance.SetControlPropertyThreadSafe(Forms.Main.Instance.tbDaysInTheFuture, "Text", (Settings.Instance.ActiveCalendarProfile.DaysInTheFuture + newDaysInFuture).ToString());
                        }
                    }
